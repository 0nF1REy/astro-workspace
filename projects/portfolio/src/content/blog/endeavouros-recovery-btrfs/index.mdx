...
<nav class="article-toc" aria-label="Guia de navegação do artigo">
  <ul>
    <li>
      <a href="#passo-1-diagnostico-via-live-usb">
        Passo 1: Diagnóstico via Live USB
      </a>
    </li>
    <li>
      <a href="#passo-2-o-dilema-do-backup">Passo 2: O dilema do backup</a>
    </li>
    <li>
      <a href="#passo-3-a-cirurgia-com-arch-chroot">
        Passo 3: A cirurgia com Arch-Chroot
      </a>
    </li>
    <li>
      <a href="#passo-4-regerar-a-configuracao-do-grub">
        Passo 4: Regerar a configuração do GRUB
      </a>
    </li>
    <li>
      <a href="#causa-raiz">Causa Raiz: O papel do MariaDB</a>
    </li>
    <li>
