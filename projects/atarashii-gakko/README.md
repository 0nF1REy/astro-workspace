...
Clone da landing page oficial do grupo japonês ATARASHII GAKKO!, apresentando discografia, datas da turnê mundial e cadastro de newsletter. O projeto foi desenvolvido com Astro e SCSS, focando em design responsivo, componentes modulares e experiência interativa.
...
> ℹ️ **Aviso de Licença:** © 2025-2026 Alan Ryan da Silva Domingues. Este projeto está licenciado sob os termos da licença MIT. Isso significa que você pode usá-lo, copiá-lo, modificá-lo e distribuí-lo com liberdade, desde que mantenha os avisos de copyright.
